...
const SignUp = () => {
    ...
    // get the elemetn from react-firebse-hook
    const [
    ...
    return (
        <div className="container mx-auto p-20">
            ...
            <h1 className="text-4xl font-bold mb-5 text-center text-blue-700">Sign Up Here</h1>
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-6">
                    ...
                    <input onBlur={handleConfirmPasswordOnBlur} type="password" id="confirmPassword" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                </div>

                <div className="flex items-start mb-6">

                    <div className="ml-3 text-sm">
                        <p>Already have account. <span className='text-orange-600 underline cursor-pointer' onClick={() => navigate("/login")}>Log In Now?</span></p>
                    </div>
                </div>
                <div>
                    <p className='mb-6 text-red-500'>{customError}</p>
