...
const LogIn = () => {
    ...
    return (
        <div className="container mx-auto p-20">
            ...
            <h1 className="text-4xl font-bold mb-5 text-center text-blue-700">Log In Here</h1>
            <form onSubmit={handleSubmit}>
                ...
                <div className="flex items-start mb-6">
                    ...
                    <div className="ml-3 text-sm">
                        <p>Not have account. <span className='text-orange-600 underline cursor-pointer' onClick={() => navigate("/signUp")}>Creat an account?</span></p>
                    </div>
                </div>
                <div>
